...
def loadBuildings():
    building1 = Polygon()
    building1.insereVertice(0, 0, 0)
    building1.insereVertice(0, 27, 0)
    building1.insereVertice(3, 27, 0)
    building1.insereVertice(3, 0, 0)
    building2 = Polygon()
    building2.insereVertice(0, 0, 0)
    building2.insereVertice(0, 16, 0)
    building2.insereVertice(11, 16, 0)
    building2.insereVertice(11, 0, 0)
    building3 = Polygon()
    building3.insereVertice(0, 0, 0)
    building3.insereVertice(0, 27, 0)
    building3.insereVertice(3, 27, 0)
    building3.insereVertice(3, 0, 0)
    building4 = Polygon()
    building4.insereVertice(0, 0, 0)
    building4.insereVertice(0, 16, 0)
    building4.insereVertice(11, 16, 0)
    building4.insereVertice(11, 0, 0)
    building5 = Polygon()
    building5.insereVertice(0, 0, 0)
    building5.insereVertice(0, 27, 0)
    building5.insereVertice(3, 27, 0)
    building5.insereVertice(3, 0, 0)
    building6 = Polygon()
    building6.insereVertice(0, 0, 0)
    building6.insereVertice(0, 16, 0)
    building6.insereVertice(1, 16, 0)
    building6.insereVertice(1, 0, 0)
